        ...
        <div class="row d-flex">
          ...
          <div class="col-md-3 d-flex ftco-animate">
            <div class="blog-entry align-self-stretch">
              <a href="blog-single.html" class="block-20" style="background-image: url('{{$job->image}}');">
              </a>
              <div class="text mt-3">
                <div class="meta mb-2">
                  <div><a href="#">{{$job->created_at}}</a></div>
                  <div><a href="#">{{$job->category->category_name}}</a></div>
                  <div><a href="#" class="meta-chat"><span class="icon-chat"></span>{{$job->location->location_name}}</a></div>
                </div>
                <h3 class="heading"><a href="#">{{$job->title}}</a></h3>
               <p>{{$job->description}}</p>
              </div>
            </div>
          </div>
